...
import style from './OldStudent.module.css'
  ...
  return (
    <div className={style.main}>
      ...
      {show ? <div className={style.inps}>
        < input placeholder='Fee Type' onChange={(e) => setFeeType(e.target.value)} />
        <input placeholder='Fee Amount' onChange={(e) => setFeeAmount(e.target.value)} />
      ...
      <span className={style.para}>
        ...
        <span style={{ color: '#4C6BBD',fontSize:"large" }}><AdjustIcon /></span> </span>
    </div>
  )
}
